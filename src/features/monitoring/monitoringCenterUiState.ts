...
export const normalizeMonitoringCenterUiState = (value: unknown): MonitoringCenterUiState => {
  ...
  return {
    ...
    // API key hashes and trace IDs are high-cardinality drilldown diagnostics.
    // Keep URL-driven exact filters supported at runtime, but do not persist
    // hidden exact filters across ordinary Monitoring visits.
    selectedApiKeyHash: defaults.selectedApiKeyHash,
