...
export const isMonitoringRecord = isRecord;
...
export const readMonitoringString = readString;
...
export const parseMonitoringBoolean = parseBoolean;
...
export const extractMonitoringArrayPayload = extractArrayPayload;
...
export const extractMonitoringHost = extractHost;
...
export const joinMonitoringUnique = joinUnique;
...
export const maskMonitoringEmail = maskEmailLike;
...
export const maskMonitoringToken = maskAuthIndex;
...
export const buildMonitoringSearchText = buildSearchText;

export const formatApiKeyHashLabel = (apiKeyHash: string) =>
  apiKeyHash ? `sk-****${apiKeyHash.slice(-4)}` : '-';
